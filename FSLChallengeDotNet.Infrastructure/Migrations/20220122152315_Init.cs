    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemDiscountRule", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ItemDiscountRule_Items_ItemId",
                        column: x => x.ItemId,
                        principalTable: "Items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemDiscountRule_ItemId",
                table: "ItemDiscountRule",
                column: "ItemId",
                unique: true);
        }
